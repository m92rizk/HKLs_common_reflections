...
void read_reflections(std::ifstream& file, std::vector<std::vector<std::string>>& table) {
    ...
    while (std::getline(file, line)) {
        ...
        if (in_table) {
            ...
            // }
            std::string h=line.substr(0,4);
            // std::cout<<"H"<<h<<std::endl;
            std::string k=line.substr(5,4);
            // std::cout<<"K"<<k<<std::endl;
            std::string l=line.substr(9,4);
            // std::cout<<"L"<<l<<std::endl;
            std::string I=line.substr(13,8);
            std::string sigma=line.substr(21,8);
            std::string sign=line.substr(30,2);


            // std::cout<<line<<std::endl;
            //   0   1   146004.09 6862.54   1  example
            //hhhhkkkklllliiiiiiiissssssss
            ...
            push_back_padded(new_row, sign, 2, 1);
            if (!printed_once) {
